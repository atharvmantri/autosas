...
// Validate ../../app/api/generate-thread/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/generate-thread">> = Specific
  const handler = {} as typeof import("../../app/api/generate-thread/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
